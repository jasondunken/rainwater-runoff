...
//RENAME LoggerID for different site
//const char* LoggerID = "AthensOX1"
const char* LoggerID = "UNCWilmington1";
...
{
    "9c4c053b-90bb-415a-acd2-61523e61c5ad",   // Specific conductance (Meter_Hydros21_Cond)
    "85363a63-b68f-4e6e-9dbd-99b94bad7a1a",   // Water depth (Meter_Hydros21_Depth)
    "e2872f3b-5a01-4aa7-9eb1-c5f4f972fdec",   // Temperature (Meter_Hydros21_Temp)
    "70e00930-4d27-48ad-8e56-5614d6fb2d9f",   // Battery voltage (EnviroDIY_Mayfly_Batt)
    "7cd68cc0-5f36-4a66-b2bc-6a94bdb58708",   // Relative humidity (Sensirion_SHT40_Humidity)
    "9f9658d4-9452-4ad0-9689-d76cb5c5fff5",   // Temperature (Sensirion_SHT40_Temperature)
    "c6895bb0-92e6-4273-bb29-5a27aa21818f"    // Percent full scale (EnviroDIY_LTEB_SignalPercent)
};
const char *registrationToken = "b4d92f58-6f77-482b-8372-124311658e63";   // Device registration token
const char *samplingFeature = "d9f7b23d-07d3-4204-93f4-9aa2ed44f030";     // Sampling feature UUID
